  ...
  return (
    <div className="w-full h-max flex flex-col items-center justify-start">
      ...
      <div className="w-full md:w-3/6 lg:w-3/6 xl:w-3/6 2xl:w-3/6 h-max my-4 px-2 flex flex-row items-center justify-between">
        <div className="group flex flex-row w-full items-center bg-lime-700 justify-center gap-2 p-1 rounded-xl border-2 px-4 border-black hover:scale-105 hover:border-lime-500 hover:text-slate-800 transition duration-300 ease-in-out hover:font-semibold">
          <a
          ...
          >
            <h2 className="text-xl font-normal text-white text-center group-hover:hidden">
              Hace tu reserva
            </h2>
